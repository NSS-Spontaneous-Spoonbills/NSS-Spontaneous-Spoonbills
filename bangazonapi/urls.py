...
router.register('training_program_sessions',
                Training_Program_Sessions_View, base_name='training_program_sessions')
router.register('user', User_View, base_name='user')
router.register('product', Product_View, base_name='product')
router.register('employee_training', Employee_Training_View,
                base_name='employee_training')
router.register('cust_order', Cust_Order_View, base_name='cust_order')
router.register('employment_dates', Employment_Dates_View,
                base_name='employment_dates')
router.register('ordered_products', Ordered_Products_View,
                base_name='ordered_products')
router.register('payment_options', Payment_Options_View,
